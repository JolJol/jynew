...
namespace ZZY_test
{
    ...
    {
        /// <summary>
        /// 调式接口，打开即在editor下使用assetbundle调试，需要先build
        /// </summary>
        ...
        private static readonly Dictionary<string, (string, string)> _assetsMap =
            new Dictionary<string, (string, string)>();

        private static readonly Dictionary<string, (string, string)> _scenesMap =
            new Dictionary<string, (string, string)>();
